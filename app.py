...
#     )
    ...
    Hi, I'm <b>Rishu Gurjar</b>, an aspiring <b>Data Engineer</b>,
    <b>Machine Learning Engineer</b>, and <b>Python Developer</b>
    currently pursuing my B.Tech in Computer Science & Engineering.

    I am passionate about building intelligent applications, working with
    data, and solving real-world problems using Artificial Intelligence
    and Machine Learning.

    My technical expertise includes Python, SQL, Machine Learning,
    Deep Learning, NLP, Data Analysis, TensorFlow, Scikit-Learn,
    Streamlit, FastAPI, Pandas, NumPy, Git, and GitHub.

    Over time, I have built multiple real-world projects including
    Email Spam Classification, Customer Churn Prediction,
    Salary Prediction System, Revenue Forecasting,
    Mental Health Prediction, and several AI-powered web applications.

    My goal is to become a skilled Data Engineer and Machine Learning
    Engineer capable of building scalable data pipelines,
    intelligent systems, and impactful AI products.
    ...
    I started my journey with Python programming and gradually expanded
    into Data Science, Machine Learning, Deep Learning, NLP,
    and Software Development.

    Every project I build helps me strengthen my understanding of
    algorithms, data processing, model development,
    deployment, and real-world problem solving.

    I believe practical learning and hands-on implementation
    are the fastest ways to grow as an engineer.
    ...
    <ul style='font-size:18px; line-height:1.8;'>
        <li>📖 Reading Books & Self-Improvement Content</li>
        <li>✍️ Writing Learning Notes & Technical Documentation</li>
        <li>🚶 Walking & Personal Reflection</li>
        <li>💡 Exploring Artificial Intelligence & Emerging Technologies</li>
    ...
    My focus is not only on writing code but also on understanding
    how technology can solve business and human problems effectively.
    ...
    I am actively looking for internships, freelance opportunities,
    collaborations, and entry-level roles in Data Engineering,
    Machine Learning, Data Science, and Python Development.

    Whether you have an exciting project, an internship opportunity,
    or simply want to connect with a fellow tech enthusiast,
